...
export default function DiscoverScreen() {
    ...
    const [selectedLocation, setSelectedLocation] =
        useState<LocationKey>("vancouver");
    ...
    const selectedGenreLabel = genreButtons.find(
    ...
    const highlightLibrariesParam = params.highlightLibraries as
        | string
        | undefined;
            ...
            >
                ...
                {(highlightedLibraries.length > 0
                    ...
                    const availableAtBranch =
                        library.available_at_this_branch === true;
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <View style={styles.sheetText}>
                                            <Text
                                                style={styles.sheetBookTitle}
                                                numberOfLines={2}
                                            >
                                                {book.title}
                                            </Text>
                                            <Text
                                                style={styles.sheetBookAuthor}
                                                numberOfLines={1}
                                            >
                                                {book.author}
                                            </Text>
